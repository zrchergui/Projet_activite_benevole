        ...
        <nav id ="navtop"class="navbar navbar-expand-sm #0d6efd  border-bottom shadow-sm p-3 px-md-4 mb-3 fixed-top  ">
                <div class="container-fluid align-items-center d-flex flex-column flex-md-row">
                    ...
                    @if (session()->has('user'))
                        ...
                        <a class="btnDevBnv rounded-circle "href={{route('EspaceBnv.show')}}>{{ $Nom }} {{ $Prenom }}</a>
                        <a class="btnDispoBnv rounded-circle" href="{{route('EspaceBnv-Dispo.show')}}">Disponibilité</a>
                        <a class="btnDevBnv rounded-circle" href="{{route('EspaceBnv-Activite.show')}}">Activité</a>
